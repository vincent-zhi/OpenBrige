...
Copy this prompt and paste it to your coding agent (Claude Code, Cursor, Codex, etc.):

复制这段话，粘贴给你的编程 Agent（Claude Code、Cursor、Codex 等）：

```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/<AGENT_NAME>/INSTALL.md and follow them. Replace <YOUR_SERVER_URL> with the OpenBrige server URL if known, otherwise use http://localhost:7443.
```

Replace `<AGENT_NAME>` with your agent:
...
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/claude-code/INSTALL.md and follow them. Replace <YOUR_SERVER_URL> with the OpenBrige server URL if known, otherwise use http://localhost:7443.
```
