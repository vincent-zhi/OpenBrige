...
Find your agent below, copy the prompt, and paste it to your agent. It will read the instructions and self-install.

找到你的 Agent，复制对应的那行 prompt，粘贴给 Agent 即可自动安装。

**Claude Code**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/claude-code/INSTALL.md and follow them.
```
**Cursor**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/cursor/INSTALL.md and follow them.
```
**GitHub Copilot**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/copilot/INSTALL.md and follow them.
```
**Codex**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/codex/INSTALL.md and follow them.
```
**Windsurf**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/windsurf/INSTALL.md and follow them.
```
**Cline**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/cline/INSTALL.md and follow them.
```
**Gemini CLI**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/gemini-cli/INSTALL.md and follow them.
```
**Aider**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/aider/INSTALL.md and follow them.
```
**OpenCode**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/opencode/INSTALL.md and follow them.
```
**TRAE SOLO**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/trae/INSTALL.md and follow them.
```
**Goose**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/goose/INSTALL.md and follow them.
```
**Roo Code**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/roo-code/INSTALL.md and follow them.
```
**Hermes**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/hermes/INSTALL.md and follow them.
```
**Continue**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/continue/INSTALL.md and follow them.
```
**Devin**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/devin/INSTALL.md and follow them.
```
**Replit**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/replit/INSTALL.md and follow them.
```
**Antigravity**
```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/antigravity/INSTALL.md and follow them.
```

<details>
<summary>More agents / 更多 Agent</summary>

Don't see your agent? Bring your own with a [YAML profile](./docs/profile-plugin.md) or [contribute a new one](./.github/CONTRIBUTING.md).

没找到你的 Agent？通过 [YAML 配置文件](./docs/profile-plugin.md) 接入，或[贡献新的适配](./.github/CONTRIBUTING.md)。
...
Zero-config profiles for popular agents. Just tell your agent to install:

热门 Agent 的零配置支持，只需一句话让 Agent 自己安装：

```
Install and configure OpenBrige for this project. Read the setup instructions at https://github.com/vincent-zhi/OpenBrige/tree/main/docs/agents/<AGENT_NAME>/INSTALL.md and follow them.
```

See [docs/agents/](./docs/agents/) for all supported agents and their setup guides.

查看 [docs/agents/](./docs/agents/) 获取所有支持的 Agent 及其安装指引。
